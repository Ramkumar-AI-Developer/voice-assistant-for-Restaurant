...
const DEFAULT_CALLS = [
  {
    ...
    messages: [
      ...
      { role: 'assistant', content: 'Got it! Extra crispy with extra chutney. Your total is ₹133.96 Shall I confirm this order?' },
  ...
  },
  {
    ...
    messages: [
      ...
      { role: 'assistant', content: 'No problem, medium spicy Paneer Butter Masala. Your total is ₹125.00 Confirm order?' },
  ...
  },
  {
    ...
    messages: [
      ...
      { role: 'assistant', content: 'Understood, less spicy Veg Noodles and one Gobi 65. The total is ₹126.49 Shall I confirm?' },
