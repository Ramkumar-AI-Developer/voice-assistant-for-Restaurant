...
const DEFAULT_ORDERS = [
  {
    ...
    items: [
      { name: 'Masala Dosa', quantity: 2, unit_price: 116.99, subtotal: 233.98, notes: 'Crispy, extra chutney' },
      { name: 'Lassi (Mango)', quantity: 2, unit_price: 114.99, subtotal: 229.98, notes: 'Cold' },
    ],
    total: 23.96,
    order_type: 'call',
    status: 'completed',
  ...
  },
  {
    ...
    items: [
      { name: 'Paneer Butter Masala', quantity: 1, unit_price: 119.50, subtotal: 119.50, notes: 'Medium spicy' },
      { name: 'Butter Naan', quantity: 2, unit_price: 112.75, subtotal: 225.50, notes: '' },
    ],
    total: 15.00,
    order_type: 'call',
    status: 'preparing',
  ...
  },
  {
    ...
    items: [
      { name: 'South Indian Meals', quantity: 1, unit_price: 120.99, subtotal: 120.99, notes: 'Takeaway' },
    ],
    total: 10.99,
    order_type: 'takeaway',
    status: 'pending',
  ...
  },
  {
    ...
    items: [
      { name: 'Idly (3 pcs)', quantity: 1, unit_price: 115.50, subtotal: 115.50, notes: 'Ghee on top' },
      { name: 'Medhu Vada (2 pcs)', quantity: 1, unit_price: 114.50, subtotal: 114.50, notes: '' },
      { name: 'Filter Coffee', quantity: 1, unit_price: 112.50, subtotal: 112.50, notes: '' },
    ],
    total: 12.50,
    order_type: 'eat in',
    status: 'ready',
  ...
  },
  {
    ...
    items: [
      { name: 'Gobi 65', quantity: 1, unit_price: 118.50, subtotal: 118.50, notes: '' },
      { name: 'Veg Noodles', quantity: 1, unit_price: 117.99, subtotal: 117.99, notes: 'Less spicy' },
    ],
    total: 16.49,
    order_type: 'call',
    status: 'confirmed',
